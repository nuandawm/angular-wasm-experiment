...
["_getSizeOfPoints","___getTypeName","__embind_initialize_bindings","_fflush","onRuntimeInitialized"].forEach((prop) => {
...
var wasmBinaryFile;
  wasmBinaryFile = 'wasm_wrapper.wasm';
...
/** @type {function(...*):?} */
var _getSizeOfPoints = Module["_getSizeOfPoints"] = createExportWrapper("getSizeOfPoints", asm);
